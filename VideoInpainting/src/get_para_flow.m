...
para.p=p;
para.q=q;
para.alpha = 0.5;  % weight of smoothness.
para.beta = 0;    % weight for descriptor positions match
...
para.inner_iter = 5;          % max iteration of the outer fixed point iteration
para.sor_iter = 25;        % max iteration of sor
para.downsampling = 0.5;   % downsampling rate
% para.sigma = 1.3;
...
para.patch_size=8;
%para.level = 130;%ceil(log2(min(para.q, para.p)/para.patch_size)); % 
